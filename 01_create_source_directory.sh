...
wget https://github.com/tudadesign/tudadesign/archive/$VERSION_NEU.tar.gz -O latex-tuddesign_$VERSION_NEU.orig.tar.gz
tar -xf latex-tuddesign_$VERSION_NEU.orig.tar.gz
mv tudadesign-$VERSION_NEU/ latex-tuddesign-$VERSION_NEU/
